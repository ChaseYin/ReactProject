...
export const PRODUCT_ANSWER_REQUEST = 'PRODUCT_ANSWER_REQUEST';
export const PRODUCT_ANSWER_SUCCESS = 'PRODUCT_ANSWER_SUCCESS';
export const PRODUCT_ANSWER_FAIL = 'PRODUCT_ANSWER_FAIL';
